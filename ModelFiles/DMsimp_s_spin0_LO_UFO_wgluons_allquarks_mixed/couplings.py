...
# Date: Tue 15 Sep 2015 12:37:11


from object_library import all_couplings, Coupling

from function_library import complexconjugate, re, im, csc, sec, acsc, asec, cot, fp, fs
...
GC_38 = Coupling(name = 'GC_38',
                 value = '(-complex(0,1)*gPg*aS)/(16.0*cmath.pi*vev)*((MU**2/MXd**2)*fp(MU**2/MXd**2)+(MD**2/MXd**2)*fp(MD**2/MXd**2)+(MS**2/MXd**2)*fp(MS**2/MXd**2)+(MC**2/MXd**2)*fp(MC**2/MXd**2)+(MB**2/MXd**2)*fp(MB**2/MXd**2)+(MT**2/MXd**2)*fp(MT**2/MXd**2))',
                 order = {'DMS':1})
...
GC_40 = Coupling(name = 'GC_40',
                 value = '(-complex(0,1)*gSg*aS)/(2.0*cmath.pi*vev)*((MU**2/MXd**2)*fs(MU**2/MXd**2)+(MD**2/MXd**2)*fs(MD**2/MXd**2)+(MS**2/MXd**2)*fs(MS**2/MXd**2)+(MC**2/MXd**2)*fs(MC**2/MXd**2)+(MB**2/MXd**2)*fs(MB**2/MXd**2)+(MT**2/MXd**2)*fs(MT**2/MXd**2))',
                 order = {'DMS':1})

GC_41 = Coupling(name = 'GC_41',
                 value = '(4*G*gSg)/Lambda',
                 order = {'DMS':1,'QCD':1})

GC_42 = Coupling(name = 'GC_42',
                 value = '(-4*complex(0,1)*G**2*gSg)/Lambda',
                 order = {'DMS':1,'QCD':2})
